...
public class JhipsterGoviesUemoaApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterGoviesUemoaApp.class);

    private final Environment env;

    public JhipsterGoviesUemoaApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterGoviesUEMOA.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterGoviesUemoaApp.class);
